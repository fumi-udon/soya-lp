...
<body class="pb-32 bg-[var(--theme-bg)] text-[#110A08] transition-colors duration-500">
    ...
    <div id="order-tracker-overlay"
        ...
        <div id="order-tracker-expanded"
            ...
            <button type="button" onclick="toggleOrderTracker(false)"
            ...
            <p
                class="text-[13px] font-bold text-[var(--theme-primary)] animate-pulse tracking-tight mb-3 px-1 leading-snug">
                Your order is not confirmed yet.
            </p>

            <p class="text-[13px] text-[#110A08] leading-relaxed mb-2">
                We've sent your request to the store.
            </p>
            <p class="text-[12px] font-mono text-[#110A08] mb-4">
                Order No. <span id="expanded-order-number" class="font-bold text-[var(--theme-primary)]"></span>
            </p>

            <p class="text-[13px] text-[#110A08] leading-relaxed font-medium mb-4">
                Confirm your order using either option below.
            </p>

            <div class="w-full flex flex-col gap-2.5 mb-4">
                <a id="order-tracker-wa-link" href="#" target="_blank" rel="noopener noreferrer"
                    ...
                    <svg class="h-5 w-5 shrink-0 text-white" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
            ...
            <button type="button" onclick="App.clearOrderStatus()"
                class="text-[#A3B8C9] hover:text-[#110A08] text-[10px] font-bold tracking-wider uppercase underline underline-offset-4">Clear
                reminder</button>
        </div>
    </div>
    ...
    <div id="order-tracker-minimized" onclick="toggleOrderTracker(true)"
        ...
        <div class="flex flex-col text-left">
            <span
                class="text-[10px] font-bold tracking-widest uppercase text-[var(--theme-primary)] leading-none mb-1">Not confirmed</span>
            <span class="text-[11px] text-[#110A08] font-mono font-bold leading-none tracking-tight">Order No. <span
    ...
    <div id="order-wa-followup"
        ...
        <p
            class="text-[13px] font-bold text-[var(--theme-primary)] text-center animate-pulse tracking-tight leading-snug px-1">
            Your order is not confirmed yet.
        </p>
        <p class="text-[12px] text-[#110A08] text-center leading-relaxed">
            We've sent your request to the store.
        </p>
        <p class="text-[12px] font-mono text-[#110A08] text-center">
            Order No. <span id="order-wa-followup-order-no" class="font-bold text-[var(--theme-primary)]"></span>
        </p>
        <p class="text-[12px] text-[#110A08] text-center font-medium leading-snug">
            Confirm your order using either option below.
        </p>
