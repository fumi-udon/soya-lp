...
<body class="pb-32 bg-[#eaedf0] text-[#110A08]">
    ...
    <div
        class="sticky top-0 z-40 bg-[#eaedf0]/90 backdrop-blur-md shadow-sm border-b border-[#A3B8C9]/30 transition-all duration-300">
        <header class="pt-3 pb-1 px-4 text-center">
            <a href="{{ url('/') }}" class="inline-block hover:opacity-70 transition-opacity">
                <h1 class="serif text-xl font-bold tracking-tight text-[#110A08]">Söya<span
            ...
            <section id="cat-{{ $category->id }}" class="section-spy pt-4 pb-6">
                <div class="px-4 mb-3 flex items-center gap-2 sticky top-[105px] z-30 pointer-events-none">
                    <div
                        ...
                        <h2 class="text-[10px] font-bold uppercase tracking-widest text-[#C5A059]">{{ $category->name }}
                        </h2>
                    </div>
                </div>
                        ...
                        <div onclick="openProductModal({{ $product->id }})"
                            ...
                            <div class="flex-1 min-w-0 flex flex-col justify-center h-full py-1">
                                ...
                                @if ($product->productVariants->count() > 0)
                                    <span
                                        class="inline-flex items-center px-2 py-0.5 rounded-[4px] text-[8px] font-bold tracking-wider bg-[#eaedf0] text-[#110A08] self-start border border-[#A3B8C9]/30">
                            ...
                            <div class="flex flex-col justify-between items-end h-full py-1 pl-2 shrink-0">
                                ...
                                <button
                                    class="w-8 h-8 rounded-full bg-[#eaedf0] text-[#110A08] flex items-center justify-center group-hover:bg-[#e60012] group-hover:text-white transition-colors duration-300">
    ...
    <div id="cart-bar"
        ...
        <div class="flex flex-col justify-center">
            ...
            <div class="font-mono font-bold text-[22px] leading-none mt-0.5 flex items-baseline gap-1 text-[#C5A059]">
                ...
                <span class="text-[10px] font-sans font-medium text-[#C5A059]/70">DT</span>
            </div>
        </div>
    ...
    <div id="product-modal"
        ...
        <div
            class="bg-[#eaedf0] w-full max-w-lg rounded-t-[2rem] sm:rounded-3xl overflow-hidden shadow-2xl max-h-[92vh] flex flex-col relative">
            <div class="p-6 pb-4 shrink-0 relative z-10 bg-white border-b border-[#A3B8C9]/30">
                <button onclick="closeModal()"
                    class="absolute top-5 right-5 w-8 h-8 flex items-center justify-center rounded-full bg-[#eaedf0] text-[#110A08] hover:bg-[#A3B8C9]/30 transition-colors">✕</button>
                ...
                <div class="space-y-2">
                    ...
                    <p id="modal-ingredients"
                        class="text-[9px] text-[#A3B8C9] uppercase tracking-wider border-l-2 border-[#e60012] pl-2 font-bold">
                    </p>
                </div>
            </div>

            <div id="modal-options" class="p-6 overflow-y-auto grow bg-[#eaedf0]"></div>
            ...
            <div class="p-5 border-t border-[#A3B8C9]/30 shrink-0 bg-white relative z-20">
                <div id="soy-character"
                    ...
                    <svg width="50" height="80" viewBox="0 0 60 90" class="drop-shadow-xl soy-shake">
                        ...
                        <path d="M18,20 L42,20 L50,80 C50,85 45,90 30,90 C15,90 10,85 10,80 L18,20 Z" fill="#110A08" />
        ...
        <div id="order-status-details" class="p-6 bg-white hidden">
            ...
            <div class="text-center mt-4">
                <button onclick="App.clearOrderStatus()"
                    class="text-[#A3B8C9] hover:text-[#110A08] text-[10px] font-bold tracking-wider uppercase underline decoration-[#eaedf0] underline-offset-4">Hide
                    Tracker</button>
            </div>
        </div>
    </div>
